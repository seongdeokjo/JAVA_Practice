...
<head>
<meta charset="UTF-8">
<title>Open Project : 회원리스트</title>
	...
	<main role="main" class="container">
		<div class="p-3 my-3 bg-white rounded shadow-sm">
			...
			<form class="form-inline">
				...
				<input type="submit" class="form-control mr-2 btn btn-success" value="검색">
			</form>
			<hr>
			...
			<table class="table">
				...
				<c:forEach items="${memberList}" var="member">
					<tr>
						...
						<td>
							<a class=" btn btn-primary" href="edit?idx=${member.memberCode}">수정</a> 
							<a class=" btn btn-danger" href="delete?idx=${member.memberCode}">삭제</a>
						</td>
					</tr>
				</c:forEach>
			</table>
