		...
		<div class="p-3 my-3 bg-white rounded shadow-sm">
			...
			<form method="post" enctype="multipart/form-data">
				<table>
					<tr>
						<th>아이디</th>
						<td><input type="text" name="memberid" id="memberid" class="form-control m-2" required>
							<span id="msg" class="display_none"></span> <img id="loadingimg"
							class="display_none" alt="loading"
							src="<c:url value="/image/loading.gif"/>"></td>
					</tr>
					<tr>
						<th>비밀번호</th>
						<td><input type="password" name="memberpw" id="memberpw" class="form-control m-2"
							required></td>
					</tr>
					<tr>
						<th>이름</th>
						<td><input type="text" name="membername" id="membername" class="form-control m-2"
							required></td>
					</tr>
					<tr>
						<th>사진</th>
						<td><input type="file" name="memberphoto" id="memberphoto" class="form-control m-2">
						</td>
					</tr>
					<tr>
						<th></th>
						<td>
							<input type="submit" class="form-control m-2 btn btn-primary"> 
							<input type="reset" class="form-control m-2 btn btn-info">
						</td>
					</tr>
				</table>
			</form>
